...
class PreguntaDesplegable(
    ...
    override fun validarSemantica(contexto: ContextoSemantico) {
        validarAtributosObligatorios(contexto, listOf("label", "options"), "DROP_QUESTION")
        validarOpcionesNoVacias(contexto, "DROP_QUESTION")
        validarIndiceCorrect(contexto, "DROP_QUESTION")
    }
}